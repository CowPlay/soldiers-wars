...
import controllers.scenes.game.views.ArrowView;
...
import models.Game.base.gameObjects.Houses.Base.*;
import models.GameInfo.Pathfinder.Node;
import models.Resources.ResourceLoader.ResourceLoader;
import models.Resources.ResourceManager.scenes.game.ResourceManagerHouses;
...
public class HouseBaseView extends BaseView implements IDisposable
{
    ...
    private function tryCreateArrowView():void
    {
        if (_arrowView != null)
        {
            StateGame(SceneBase.currentScene).didArrowRemove(this);
        ...
        if (_ownerType == EHouseOwner.EHO_PLAYER)
        {
            ...
            StateGame(SceneBase.currentScene).didArrowCreate(this);
        }
    }
