package core.models.implementations.social.vk.api
{

import core.models.implementations.social.vk.api.serialization.json.JSON;
...
public class DataProvider
{
    ...
    private function _sendRequest(method:String, options:Object):void
    {
        ...
        loader.addEventListener(Event.COMPLETE, function (e:Event):void
        {
            ...
            trace(loader.data);
            var data:Object =  core.models.implementations.social.vk.api.serialization.json.JSON.decode(loader.data);
            if (data.error)
            {
