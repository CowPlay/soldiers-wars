...
{
import core.serialization.json.JSON;
...
public class URLConnector
{
    ...
    public function send(path:String, onComplete:Function, onError:Function, params:Object):void
    {
        ...
        if (_isSending)
        {
            addQuery(path, onComplete, onError, params);
            return;
        }
    ...
    private static function decode(str:String):Object
    {
        var result:Object;
