package core.socialApi.vk
{
import core.socialApi.vk.api.DataProvider;
import core.socialApi.vk.events.*;
...
public class APIConnection extends EventDispatcher
{
    ...
    public function APIConnection(...params)
    {
        ...
        else
        {
            ...
            dp = new DataProvider(api_url, Number(params[0].api_id), String(params[0].sid), String(params[0].secret), params[0].viewer_id);
        }
