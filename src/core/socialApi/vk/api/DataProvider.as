package core.socialApi.vk.api {
  
  import flash.net.*;
  import flash.errors.*;
  import flash.events.*;
  
  import core.socialApi.vk.api.serialization.json.*;
  ...
  public class DataProvider {    
    ...
    private function _sendRequest(method:String, options:Object):void {
      ...
      loader.addEventListener(Event.COMPLETE, function(e:Event):void{
		...
		trace(loader.data);
		var data: Object = core.socialApi.vk.api.serialization.json.JSON.decode(loader.data);
        if (data.error) {
