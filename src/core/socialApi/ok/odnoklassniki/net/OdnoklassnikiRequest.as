package core.socialApi.ok.odnoklassniki.net
{
	import core.socialApi.ok.adobe.images.PNGEncoder;
	...
	public class OdnoklassnikiRequest
	{
		...
		{
			if(_format == "JSON"){
				_data = core.socialApi.ok.adobe.json.JSON.decode(urlLoader.data);
				try {
