package core.socialApi.ok.odnoklassniki
{
import core.socialApi.ok.adobe.json.JSON;
import core.socialApi.ok.odnoklassniki.core.OdnoklassnikiSession;
import core.socialApi.ok.odnoklassniki.events.ApiServerEvent;
import core.socialApi.ok.odnoklassniki.net.OdnoklassnikiRequest;
...
public class Odnoklassniki extends EventDispatcher
{
     ...
     */
    public static function call(method:String, params:Array = null):void
    {
     ...
     */
    public static function callRestApi(method:String, callback:Function, params:Object = null, format:String = 'JSON', requestMethod:String = "GET", url:String = null):void
    {
        getInstance().doCallRestApi(method, callback, params, format, requestMethod, url);
    }

    private function doCallRestApi(method:String, callback:Function, params:Object = null, format:String = 'JSON', requestMethod:String = "GET", url:String = null):void
    {
    ...
    {
        getInstance().send("showPermissions", [core.socialApi.ok.adobe.json.JSON.encode(permissions)]);
    }
