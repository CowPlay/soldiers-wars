package core.socialApi.ok.odnoklassniki.sdk.stream
{
	...
	public class Stream 
	{
		...
		public static function publish(confirmation_message:String, publish_message:String, callback:Function, uid:String = "", attachment:Object = null, action_links:Array = null):void
		{
			...
			if (attachment) _request.attachment = core.socialApi.ok.adobe.json.JSON.encode(attachment);
			if (action_links) _request.action_links = core.socialApi.ok.adobe.json.JSON.encode(action_links);
