...
public class ResourceLoader implements IDisposable
{
    ...
    public static function getClass(className:String):Class
    {
        ...
        for each(var loader:ResourceLoader in _loaders)
        {
    ...
    private static function removeLoader(loader:ResourceLoader):void
    {
    ...
    //! Default constructor
    public function ResourceLoader(libName:String)
    {
